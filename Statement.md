...
It does not include:
	...
	•	Cloud or database features
	•	Machine learning, analytics history, or predictions
	•	Graphical UI (CLI/application only)
...
The tool is simple, lightweight, and intended for daily personal productivity use.
